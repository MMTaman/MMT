...
var preloadMenu = document.querySelector('.preloaderText');
var firstName = document.querySelector('.animatedText');
var lastName = document.querySelector('.animatedText2');
var line = document.querySelector('.lineUnderText');
var initiator = function initiator() {
  lastName.style.visibility = "hidden";
  line.style.visibility = "hidden";
  setTimeout(function () {
    return lastName.style.visibility = 'visible';
  }, 300);
  setTimeout(function () {
    return line.style.visibility = 'visible';
  }, 500);
  setTimeout(function () {
    return fadeOutEffect(preloadMenu);
  }, 1800);
};
var fadeOutEffect = function fadeOutEffect(target) {
...
},{}],"js/containerShown.js":[function(require,module,exports) {
...
var linked = document.querySelector(".header .linked");
...
var afterInitiator = function afterInitiator() {
  ...
  setTimeout(function () {
    return location.style.visibility = "visible";
  }, 2900);
  setTimeout(function () {
    return profilepic.style.visibility = "visible";
  }, 2900);
  setTimeout(function () {
    return hello.style.visibility = "visible";
  }, 3200);
  setTimeout(function () {
    return myName.style.visibility = "visible";
  }, 3300);
  setTimeout(function () {
    return about.style.visibility = "visible";
  }, 3500);
  setTimeout(function () {
    return linked.style.visibility = "visible";
  }, 3700);
  setTimeout(function () {
    return aboutme.style.visibility = "visible";
  }, 3800);
  setTimeout(function () {
    return about1.style.visibility = "visible";
  }, 3900);
  setTimeout(function () {
    return about2.style.visibility = "visible";
  }, 4000);
  setTimeout(function () {
    return sig.style.visibility = "visible";
  }, 4100);
};
window.addEventListener('load', afterInitiator);
},{}],"js/arrowAnimation.js":[function(require,module,exports) {
var arrow = document.querySelectorAll(".linked .arrow");
var linked = document.querySelectorAll(".linked");
linked.forEach(function (el, i) {
...
},{}],"js/contactModal.js":[function(require,module,exports) {
var linked = document.querySelectorAll(".linked");
...
var getCursorPosition = function getCursorPosition() {
  ...
  var y = event.clientY;
  console.log(x, y);
  popUp.style.top = "".concat(y - 40, "px");
  popUp.style.left = "".concat(x, "px");
};
mail.addEventListener('click', getCursorPosition);
},{}],"js/workSlider.js":[function(require,module,exports) {
...
var workbox = document.querySelector(".workInsideBox");
var rBtn = document.querySelector("#rightBtn");
var lBtn = document.querySelector("#leftBtn");
var picsNode = document.querySelectorAll(".frame");
var pics = _toConsumableArray(picsNode);
var width = pics[0].offsetWidth;
console.log(width * (pics.length - 3));
var widthMargined = width * (pics.length - 3);
var i = 0;
var run = 3;
var remainderPics = pics.length - 3;
var shiftingRight = function shiftingRight() {
  if (remainderPics >= 3) {
    run = 3;
    remainderPics -= 3;
    console.log({
      i: i,
      run: run,
      remainderPics: remainderPics
    });
    if (i >= -(pics.length - 3) * width) {
      i -= width * run;
      if (i >= -(pics.length - 3) * width) {
        pics[0].style.marginLeft = "".concat(i, "px");
      } else return;
    }
...
var shiftingLeft = function shiftingLeft() {
  if (remainderPics === 0 || remainderPics + 3 < pics.length - pics.length % 3) {
    remainderPics += 3;
    run += 3 - run;
    console.log({
      i: i,
...
require("./preloader");
require("./containerShown");
require("./arrowAnimation");
require("./contactModal");
require("./workSlider");
var _lodash = _interopRequireDefault(require("lodash"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./preloader":"js/preloader.js","./containerShown":"js/containerShown.js","./arrowAnimation":"js/arrowAnimation.js","./contactModal":"js/contactModal.js","./workSlider":"js/workSlider.js","lodash":"../node_modules/lodash/lodash.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
